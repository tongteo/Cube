...
wasm: ./src/solver_library.c ./src/utils.c ./src/cube.c ./src/cross.c ./src/f2l.c ./src/lastlayer.c ./src/wasm_interface.c
	emcc -o ./bin/solver.js ./src/solver_library.c ./src/utils.c ./src/cube.c ./src/cross.c ./src/f2l.c ./src/lastlayer.c ./src/wasm_interface.c --preload-file data -s EXPORTED_FUNCTIONS="['_solve_cube_wasm']" -s EXTRA_EXPORTED_RUNTIME_METHODS="['ccall']"
